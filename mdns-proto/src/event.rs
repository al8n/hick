...
impl<'a> ProbeConflict<'a> {
  #[allow(dead_code)]
  #[inline(always)]
  pub(crate) const fn new(src: SocketAddr, record: RecordRef<'a>) -> Self {
    Self { src, record }
  }
...
impl<'a> HostConflict<'a> {
  #[allow(dead_code)]
  #[inline(always)]
  pub(crate) const fn new(record: RecordRef<'a>) -> Self {
    Self { record }
  }
  /// Returns the conflicting DNS record observed from a peer.
  #[inline(always)]
...
impl<'a> KnownAnswer<'a> {
  #[allow(dead_code)]
  #[inline(always)]
  pub(crate) const fn new(src: core::net::SocketAddr, record: RecordRef<'a>) -> Self {
    Self { src, record }
  }
