...
pub mod event;
/// Outgoing-datagram descriptor and the I/O-world vocabulary its confirm speaks.
pub mod transmit;

pub use event::{
  ConflictOrigin, DatagramId, EndpointEvent, HostConflict, KnownAnswer, ProbeConflict,
